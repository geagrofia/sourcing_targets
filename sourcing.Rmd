...
list(
    tar_target(r_ISO_file1, r_ISO_make_write1_f(v_ISO, r_lc, v_ISO_extent, ISO)),
    tar_target(r_ISO_file2, r_ISO_make_write2_f(r_ISO_file1, v_ISO_extent)),
    tar_target(r_ISO_file3, r_ISO_make_write3_f(r_ISO_file2, ISO)),
    tar_target(r_ISO, r_ISO_get_f(r_ISO_file3, ISO))
)
...
```{targets spatial_data_preparation_processing_5}

list(
  tar_target(
    v_crop_ISO_lc_rcl_agg,
    v_crop_ISO_lc_rcl_agg_get_f(v_crop_ISO_lc_rcl_agg_file1, ISO, crop, v_ISO1)
  ),
  tar_target(
...
list(
  ...
  tar_target(
    dB_profile_d_l_f_l_plot,
    dB_profile_d_l_f_l_plot_make_f(v_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profile_h_l_f_l_plot,
    dB_profile_h_l_f_l_plot_make_f(v_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
    tar_target(
    dB_profile_d_l_h_l_f_l_plot,
    dB_profile_d_l_h_l_f_l_plot_make_f(v_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
...
tar_read(dB_profile_d_l_h_l_plot)
...
tar_read(dB_profile_d_l_f_l_plot)
...
tar_read(dB_profile_h_l_f_l_plot)
...
tar_read(dB_profile_d_l_h_l_f_l_plot)
