...
#list(
#  tar_target(vect_crop, vect_crop_get_f(cc_data, cc_row)),
  
#  tar_target(vect_crop_extent, vect_crop_extent_f(vect_crop)),
#  tar_target(
#    vect_crop_plot,
#    vect_crop_plot_f(vect_crop, vect_crop_extent, ISO, crop, world)
#  ),
  
#  tar_target(vect_ISO, vect_ISO_get_f(ISO)),
#  tar_target(vect_ISO1, vect_ISO1_get_f(ISO)),
#  tar_target(vect_ISO_extent, vect_ISO_extent_f(vect_ISO)),
#  tar_target(vect_ISO_plot, vect_ISO_plot_f(vect_ISO, ISO)),
...
#list(
#  tar_target(vect_crop, vect_crop_f(vect_crop))
#)
#
```
...
list(
  tar_target(
    vect_crop_plot,
    vect_crop_plot_f(vect_crop, ISO, crop, world))
)
...
list(
  tar_target(vect_ISO1, vect_ISO1_get_f(cc_data, cc_row, ISO))
)
...
list(
  tar_target(rast_lc_file,  rast_lc_make_write_f(rast_lc_global, aggregation_value, vect_ISO, ISO))
)
...
list(
    tar_target(rast_ISO_a_file, rast_ISO_a_make_write_f(vect_ISO, rast_lc, ISO)),
...
#list(
#    tar_target(rast_ISO_b_file, rast_ISO_b_make_write_f(rast_ISO_a, vect_ISO_extent, ISO)),
...
list(
    tar_target(rast_ISO_file, rast_ISO_make_write_f(rast_ISO_a, vect_ISO, ISO))
)
...
list(
  tar_target(rast_crop_file, rast_crop_make_write_f(vect_crop, rast_lc_ISO, ISO, crop))
)
...
list(
tar_target(
  vect_crop_ISO_lc_rcl_agg_file1,
  vect_crop_ISO_lc_rcl_agg1_make_write_f(rast_crop_ISO_lc_rcl_agg,  ISO, crop)
)
)
...
list(tar_target(
  vect_crop_ISO_lc_rcl_agg_file2,
  vect_crop_ISO_lc_rcl_agg2_make_write_f
  (vect_crop_ISO_lc_rcl_agg,  ISO, crop)
))
...
list(
  tar_target(wkt_lam, wkt_lam_make_f(vect_ISO)),
  tar_target(crs_lam, crs_lam_make_f(wkt_lam)),
  tar_target(
    vect_crop_ISO_lc_rcl_agg_proj_file,
    vect_crop_ISO_lc_rcl_agg_proj_file_make_write_f(vect_crop_ISO_lc_rcl_agg, crs_lam, ISO, crop)
  ),
  tar_target(
    vect_crop_ISO_lc_rcl_agg_proj,
    vect_crop_ISO_lc_rcl_agg_proj_get_f(vect_crop_ISO_lc_rcl_agg_proj_file, ISO, crop)
  ),
  tar_target(
    dB_crop_ISO_lc_rcl_agg_proj,
    dB_crop_ISO_lc_rcl_agg_proj_make_f(vect_crop_ISO_lc_rcl_agg_proj, vect_ISO1, ISO, crop)
  ),
  tar_target(
...
list(
  tar_target(
    rast_lc_ISO_plot,
    rast_lc_ISO_plot_f(rast_lc_ISO, world, vect_ISO, ISO)
  ),
  tar_target(
    rast_crop_ISO_plot,
    rast_crop_ISO_plot_f(rast_crop_ISO, vect_ISO1, ISO, crop)
  ),
  tar_target(
    rast_crop_ISO_lc_plot,
    rast_crop_ISO_lc_plot_f(rast_crop_ISO_lc, vect_ISO1, ISO, crop)
  ),
  tar_target(
    rast_crop_ISO_lc_rcl_plot,
    rast_crop_ISO_lc_rcl_plot_f(rast_crop_ISO_lc_rcl, vect_ISO1, ISO, crop)
  )
  ,
  tar_target(
    vect_crop_ISO_lc_rcl_agg_plot,
    vect_crop_ISO_lc_rcl_agg_plot_f
    (vect_crop_ISO_lc_rcl_agg, vect_ISO1, ISO, crop)
  )
)
...
list(
  tar_target(rast_clim_mask_trim_file, rast_clim_mask_trim_file_make_write_f(vect_ISO, rast_clim_mask, ISO)),
...
list(
  tar_target(
    ...
    dB_rainfallc_summary_make_f(rast_rainfallc, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_rainfallf_summary,
    dB_rainfallf_summary_make_f(rast_rainfallf, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_rainfall_change_summary,
    dB_rainfall_change_summary_make_f(rast_rainfall_change, vect_crop_ISO_lc_rcl_agg)
  )
)
...
list(
  tar_target(
    dB_tempc_summary,
    dB_tempc_summary_make_f(rast_tempc, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_tempf_summary,
    dB_tempf_summary_make_f(rast_tempf, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_temp_change_summary,
    dB_temp_change_summary_make_f(rast_temp_change, vect_crop_ISO_lc_rcl_agg)
  )
)
...
list(
  tar_target(
    dB_onsetc_summary,
    dB_onsetc_summary_make_f(rast_onsetc, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_onsetf_summary,
    dB_onsetf_summary_make_f(rast_onsetf, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_onset_change_summary,
    dB_onset_change_summary_make_f(rast_onset_change, vect_crop_ISO_lc_rcl_agg)
  )
)
...
list(
  tar_target(
    ...
    dB_durationc_summary_make_f(rast_durationc, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_durationf_summary,
    dB_durationf_summary_make_f(rast_durationf, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_duration_change_summary,
    dB_duration_change_summary_make_f(rast_duration_change, vect_crop_ISO_lc_rcl_agg)
  )
)
...
list(
  tar_target(
    dB_droughtc_summary,
    dB_droughtc_summary_make_f(rast_droughtc, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_droughtf_summary,
    dB_droughtf_summary_make_f(rast_droughtf, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_drought_change_summary,
    dB_drought_change_summary_make_f(rast_drought_change, vect_crop_ISO_lc_rcl_agg)
  )
)
...
list(
  tar_target(
    dB_heatc_summary,
    dB_heatc_summary_make_f(rast_heatc, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_heatf_summary,
    dB_heatf_summary_make_f(rast_heatf, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_heat_change_summary,
    dB_heat_change_summary_make_f(rast_heat_change, vect_crop_ISO_lc_rcl_agg)
  )
)
...
list(
  tar_target(
    dB_floodc_summary,
    dB_floodc_summary_make_f(rast_floodc, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_floodf_summary,
    dB_floodf_summary_make_f(rast_floodf, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_flood_change_summary,
    dB_flood_change_summary_make_f(rast_flood_change, vect_crop_ISO_lc_rcl_agg)
  )
)
...
list(
  tar_target(vect_impact, vect_impact_make_f(dB_impact_full)),
  tar_target(
    rast_impact_prelim,
...
list(tar_target(rast_impact_file,
...
```{targets impact_cat_table_1}

list(
    tar_target(impact_cat_table, impact_cat_table_make_f())
)
...
list(
  tar_target(
    ...
    dB_droughtc_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_droughtf_l_summary,
    dB_droughtf_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_drought_change_l_summary,
    dB_drought_change_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
    tar_target(
    dB_droughtc_u_summary,
    dB_droughtc_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_droughtf_u_summary,
    dB_droughtf_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_drought_change_u_summary,
    dB_drought_change_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  )
...
list(
  tar_target(
    ...
    dB_heatc_l_summary_values_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),  
  tar_target(
    dB_heatc_l_summary,
    dB_heatc_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_heatf_l_summary,
    dB_heatf_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_heat_change_l_summary,
    dB_heat_change_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
    tar_target(
    dB_heatc_u_summary,
    dB_heatc_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_heatf_u_summary,
    dB_heatf_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_heat_change_u_summary,
    dB_heat_change_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  )
...
list(
  tar_target(
    dB_floodc_l_summary,
    dB_floodc_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_floodf_l_summary,
    dB_floodf_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_flood_change_l_summary,
    dB_flood_change_l_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
    tar_target(
    dB_floodc_u_summary,
    dB_floodc_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_floodf_u_summary,
    dB_floodf_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_flood_change_u_summary,
    dB_flood_change_u_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  )
...
list(
  tar_target(
    dB_profile_summary,
    dB_profile_summary_make_f(rast_impact, vect_crop_ISO_lc_rcl_agg)
  ),
  tar_target(
    dB_profile_summary_file,
    dB_profile_summary_file_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
...
list(
  tar_target(
    ...
    dB_profilec_d_l_h_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_l_f_l_plot,
    dB_profilec_d_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_h_l_f_l_plot,
    dB_profilec_h_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
    tar_target(
    dB_profilec_d_l_h_l_f_l_plot,
    dB_profilec_d_l_h_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
```  
...
list(
    ...
    dB_profilec_d_u_h_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_u_f_u_plot,
    dB_profilec_d_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_h_u_f_u_plot,
    dB_profilec_h_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
    tar_target(
    dB_profilec_d_u_h_u_f_u_plot,
    dB_profilec_d_u_h_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
...
list(
    ...
    dB_profilec_d_u_h_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_l_h_u_plot,
    dB_profilec_d_l_h_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_u_f_l_plot,
    dB_profilec_d_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_l_f_u_plot,
    dB_profilec_d_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_h_u_f_l_plot,
    dB_profilec_h_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_h_l_f_u_plot,
    dB_profilec_h_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
    tar_target(
    dB_profilec_d_u_h_l_f_l_plot,
    dB_profilec_d_u_h_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_l_h_u_f_l_plot,
    dB_profilec_d_l_h_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_l_h_l_f_u_plot,
    dB_profilec_d_l_h_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_u_h_u_f_l_plot,
    dB_profilec_d_u_h_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_u_h_l_f_u_plot,
    dB_profilec_d_u_h_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilec_d_l_h_u_f_u_plot,
    dB_profilec_d_l_h_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
...
list(
  tar_target(
    ...
    dB_profilef_d_l_h_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_l_f_l_plot,
    dB_profilef_d_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_h_l_f_l_plot,
    dB_profilef_h_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
    tar_target(
    dB_profilef_d_l_h_l_f_l_plot,
    dB_profilef_d_l_h_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
```  
...
list(
    ...
    dB_profilef_d_u_h_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_u_f_u_plot,
    dB_profilef_d_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_h_u_f_u_plot,
    dB_profilef_h_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
    tar_target(
    dB_profilef_d_u_h_u_f_u_plot,
    dB_profilef_d_u_h_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
...
list(
    ...
    dB_profilef_d_u_h_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_l_h_u_plot,
    dB_profilef_d_l_h_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_u_f_l_plot,
    dB_profilef_d_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_l_f_u_plot,
    dB_profilef_d_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_h_u_f_l_plot,
    dB_profilef_h_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_h_l_f_u_plot,
    dB_profilef_h_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
    tar_target(
    dB_profilef_d_u_h_l_f_l_plot,
    dB_profilef_d_u_h_l_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_l_h_u_f_l_plot,
    dB_profilef_d_l_h_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_l_h_l_f_u_plot,
    dB_profilef_d_l_h_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_u_h_u_f_l_plot,
    dB_profilef_d_u_h_u_f_l_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_u_h_l_f_u_plot,
    dB_profilef_d_u_h_l_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  ),
  tar_target(
    dB_profilef_d_l_h_u_f_u_plot,
    dB_profilef_d_l_h_u_f_u_plot_make_f(vect_crop_ISO_lc_rcl_agg, dB_profile_summary, ISO, crop)
  )
)
...
tar_read(vect_crop_ISO_lc_rcl_agg_plot)
