...
vect_ISO <- vect_ISO_get_f(ISO)

```

```{r country_crop_data_e, echo=FALSE, message=FALSE, warning=FALSE}

vect_ISO1 <- vect_ISO1_get_f(cc_data, cc_row, ISO)
...
```{r country_crop_data_i, echo=FALSE, message=FALSE, warning=FALSE}

rast_lc_global <- rast_lc_global_get_f(rast_clim_mask, cc_data, cc_row)

```

```{r country_crop_data_j, echo=FALSE, message=FALSE, warning=FALSE}

rast_lc_file <- rast_lc_make_write_f(rast_lc_global, aggregation_value, vect_ISO, ISO)

```

```{r country_crop_data_k, echo=FALSE, message=FALSE, warning=FALSE}

rast_lc <- rast_lc_get_f(rast_lc_file, ISO)

```

```{r country_crop_data_l, echo=FALSE, message=FALSE, warning=FALSE}
...
rast_crop_ISO_lc_rcl_agg_file  <- rast_crop_ISO_lc_rcl_agg_make_write_f(rast_crop_ISO_lc_rcl, ISO, crop)

```

```{r spatial_data_prep_processing_4aii, echo=FALSE, message=FALSE, warning=FALSE}

rast_crop_ISO_lc_rcl_agg  <- rast_crop_ISO_lc_rcl_agg_get_f(rast_crop_ISO_lc_rcl_agg_file, ISO, crop)

```

```{r spatial_data_prep_processing_4b, echo=FALSE, message=FALSE, warning=FALSE}
  
rast_crop_ISO_lc_rcl_agg_values  <- rast_crop_ISO_lc_rcl_agg_values_get_f(rast_crop_ISO_lc_rcl_agg)

rast_crop_ISO_lc_rcl_agg_values_vec0  <- c(0)
rast_crop_ISO_lc_rcl_agg_values_vec1  <- c(1)
rast_crop_ISO_lc_rcl_agg_values_vec2  <- c(2)
rast_crop_ISO_lc_rcl_agg_values_vec01  <- c(0, 1)
rast_crop_ISO_lc_rcl_agg_values_vec02  <- c(0, 2)
rast_crop_ISO_lc_rcl_agg_values_vec12  <- c(1, 2)

```

```{r spatial_data_prep_processing_4c, echo=FALSE, message=FALSE, warning=FALSE}

vect_crop_ISO_lc_rcl_agg_file1  <- vect_crop_ISO_lc_rcl_agg1_make_write_f(rast_crop_ISO_lc_rcl_agg,  ISO, crop)
...
vect_crop_ISO_lc_rcl_agg  <-  vect_crop_ISO_lc_rcl_agg_get_f(
...
vect_crop_ISO_lc_rcl_agg_file2  <- vect_crop_ISO_lc_rcl_agg2_make_write_f (vect_crop_ISO_lc_rcl_agg,  ISO, crop)
...
vect_crop_ISO_lc_rcl_agg_proj_file  <- vect_crop_ISO_lc_rcl_agg_proj_file_make_write_f(vect_crop_ISO_lc_rcl_agg, crs_lam, ISO, crop)


vect_crop_ISO_lc_rcl_agg_proj  <- vect_crop_ISO_lc_rcl_agg_proj_get_f(vect_crop_ISO_lc_rcl_agg_proj_file, ISO, crop)


dB_crop_ISO_lc_rcl_agg_proj  <- dB_crop_ISO_lc_rcl_agg_proj_make_f(vect_crop_ISO_lc_rcl_agg_proj, vect_ISO1, ISO, crop)


dB_crop_ISO_lc_rcl_agg_proj_plot <- dB_crop_ISO_lc_rcl_agg_proj_plot_f(dB_crop_ISO_lc_rcl_agg_proj)
...
```{r spatial_data_prep_plots_e, echo=FALSE, message=FALSE, warning=FALSE}

vect_crop_ISO_lc_rcl_agg_plot <- vect_crop_ISO_lc_rcl_agg_plot_f(vect_crop_ISO_lc_rcl_agg, vect_ISO1, ISO, crop)
